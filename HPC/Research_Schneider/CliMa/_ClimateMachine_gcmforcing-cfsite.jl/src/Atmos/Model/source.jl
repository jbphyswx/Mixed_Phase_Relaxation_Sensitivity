...
function atmos_source!(
    ...
    if new_method
        S_q_ice = conv_q_vap_to_q_liq_ice2(atmos.param_set.microphys.ice, q_sat_ice, q_vap)
        S_q_liq = conv_q_vap_to_q_liq_ice2(atmos.param_set.microphys.liq, q_sat_liq, q_vap)

        # S_q_ice = conv_q_vap_to_q_liq_ice2(atmos.param_set.microphys.ice, q_eq, q)
        # S_q_ice = conv_q_vap_to_q_liq_ice2(atmos.param_set.microphys.ice, q_eq, q)
        ...
        S_q_liq = conv_q_vap_to_q_liq_ice(atmos.param_set.microphys.liq, atmos.param_set.microphys.ice, q_eq, q) # use the alternate implementation in source.jl
